...
import com.fmpro.entity.OrderDetail;
import com.fmpro.entity.Product;
import com.fmpro.model.CartInfo;
import com.fmpro.model.CartLineInfo;
...
public class OrderDAO {
    ...
    public void  deleteOrderById(int orderId) {
    	String sql = "delete from "+Order.class.getName()+" d "+"where d.order.id = :orderId";
    	Session session = this.sessionFactory.getCurrentSession();
        session.createNamedQuery(sql).executeUpdate();
